...
const { addRoom, getAllRooms, updateRoom, deleteRoom, getRoomDetails, getReviews, postReviews } = require("../controllers/roomController");
...
router.post('/api/rooms/:id/reviews', postReviews);
